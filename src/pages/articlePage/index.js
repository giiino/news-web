            ...
            <NewsPageWrapper>
                {
                    ...
                    <NewsPageNav>
                        <NavItem>
                            <NavItemLink to='/news' onClick={() => { handleChangeTopic(0)}}>All News</NavItemLink>
                        </NavItem>
                        <NavItem>
                            <NavItemLink to='/news' onClick={() => { handleChangeTopic(1)}}>Covid-19 News</NavItemLink>
                        </NavItem>
                        <NavItem>
                            <NavItemLink to='/news' onClick={() => { handleChangeTopic(2)}}>Taiwan News</NavItemLink>
                        </NavItem>
                        <NavItem>
                            <NavItemLink to='/news' onClick={() => { handleChangeTopic(3)}}>China News</NavItemLink>
                        </NavItem>
                        <NavItem>
                            <NavItemLink to='/news' onClick={() => { handleChangeTopic(4)}}>The USA News</NavItemLink>
                        </NavItem>
                        <NavItem>
                            <NavItemLink to='/news' onClick={() => { handleChangeTopic(5)}}>Anime News</NavItemLink>
                        </NavItem>
                    </NewsPageNav>  
