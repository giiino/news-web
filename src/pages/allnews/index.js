            ...
            <NewsPageWrapper>
                {
                    ...
                    <BeatLoader className='loadingSpinner' color={"#2A53C1"} size={30} />
                    ...
                    <NewsPageNav>
                        <NavItem>
                            <NavItemLink className={(topicNum===0) && 'active'} onClick={() => { handleChangeTopic(0)}}>All News</NavItemLink>
                        </NavItem>
                        <NavItem>
                            <NavItemLink className={(topicNum===1) && 'active'} onClick={() => { handleChangeTopic(1)}}>Covid-19 News</NavItemLink>
                        </NavItem>
                        <NavItem>
                            <NavItemLink className={(topicNum===2) && 'active'} onClick={() => { handleChangeTopic(2)}}>Taiwan News</NavItemLink>
                        </NavItem>
                        <NavItem>
                            <NavItemLink className={(topicNum===3) && 'active'} onClick={() => { handleChangeTopic(3)}}>China News</NavItemLink>
                        </NavItem>
                        <NavItem>
                            <NavItemLink className={(topicNum===4) && 'active'} onClick={() => { handleChangeTopic(4)}}>The USA News</NavItemLink>
                        </NavItem>
                        <NavItem>
                            <NavItemLink className={(topicNum===5) && 'active'} onClick={() => { handleChangeTopic(5)}}>Anime News</NavItemLink>
                        </NavItem>
                    </NewsPageNav>
                    <SelectBar handleChangeTopic={handleChangeTopic} topicNum={topicNum}/>
                    {
                        showlist.map((item) =>{
                            return <NewsSection 
                                        key={v4()} 
