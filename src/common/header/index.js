...
class Header extends PureComponent {
    render() {
        const { isOpen, user, toTopState, handleCloseSidebar, handleOpenSidebar, handleChangeTerm, handleLogOut, handleBoxOpen} = this.props;
        return (
            <>
            <HeaderWrapper>
                <HeaderContainer>
                    <MobIcon isOpen={isOpen}>
                        {
                            isOpen ? <FaTimes onClick={handleCloseSidebar} /> : <VscThreeBars onClick={handleOpenSidebar} />
                        }
                    </MobIcon>
                    <HeaderNav/>
