...
class Register extends PureComponent {
    render(){
        const { registerBoxOpen, failState, error, loading, handleBoxClose, handleRegister, handleChangeMode } = this.props
            return (
                <>
                {
                    registerBoxOpen ?
                    ...
                    <LoginWrapper>
                        <motion.div initial='out' animate='in' exit='out' variants={animateTwo} transition={transitionTwo}>
                            <LoginBox>
                                ...
                                <UserInput placeholder='yourname' ref={(input)=>{this.username=input}}/>
                                ...
                                <SubmitBtn onClick={()=>{handleRegister(this.username.value,this.account.value,this.password.value)}}>Submit</SubmitBtn>
                                <BoxUnderText>
